...
template <> constexpr inline auto LoginDialog::qt_create_metaobjectdata<qt_meta_tag_ZN11LoginDialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "irParaLoginExterno",
        "",
        "irParaCadastroExterno",
        "voltarParaInicio",
        "realizarLoginInstitucional",
        "realizarLogin",
        "realizarCadastro"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'irParaLoginExterno'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'irParaCadastroExterno'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'voltarParaInicio'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'realizarLoginInstitucional'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'realizarLogin'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'realizarCadastro'
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->irParaLoginExterno(); break;
        case 1: _t->irParaCadastroExterno(); break;
        case 2: _t->voltarParaInicio(); break;
        case 3: _t->realizarLoginInstitucional(); break;
        case 4: _t->realizarLogin(); break;
        case 5: _t->realizarCadastro(); break;
        default: ;
        }
    }
    (void)_a;
